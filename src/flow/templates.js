  ...
  nodes: [
    ...
    { id: 'cond_menu', type: 'condition', position: { x: 360, y: 70 }, data: { cases: [
      { label: 'Ser proveedor', logic: 'OR', rules: [
        ...
        { field: 'message', op: 'contains', value: 'prestador' },
        { field: 'message', op: 'contains', value: 'registr' },
        { field: 'message', op: 'contains', value: 'inscrib' },
        { field: 'message', op: 'contains', value: 'enrolar' },
        { field: 'message', op: 'contains', value: 'ofrezco' },
        { field: 'message', op: 'contains', value: 'ofresco' },
        { field: 'message', op: 'contains', value: 'ofrecer' },
        { field: 'message', op: 'contains', value: 'ofrec' },
        { field: 'message', op: 'contains', value: 'mis servicios' },
        { field: 'message', op: 'contains', value: 'me dedico' },
        { field: 'message', op: 'contains', value: 'trabajo de' },
        { field: 'message', op: 'contains', value: 'trabajo como' },
        { field: 'message', op: 'contains', value: 'dar de alta' },
        { field: 'message', op: 'contains', value: 'darme de alta' },
        { field: 'message', op: 'contains', value: 'unirme' },
        { field: 'message', op: 'contains', value: 'anunci' },
        { field: 'message', op: 'contains', value: 'quiero ser' },
        { field: 'message', op: 'contains', value: 'soy ' },
      ] },
      { label: 'Ver todos', logic: 'OR', rules: [
        { field: 'message', op: 'contains', value: '3' },
        { field: 'message', op: 'contains', value: 'todos' },
        { field: 'message', op: 'contains', value: 'todas' },
      ...
      { label: 'Buscar', logic: 'OR', rules: [
        ...
        { field: 'message', op: 'contains', value: 'busco' },
        { field: 'message', op: 'contains', value: 'necesito' },
        { field: 'message', op: 'contains', value: 'ocupo' },
        { field: 'message', op: 'contains', value: 'requiero' },
...
const buscador = () => ({
  nodes: [
    { id: 'start', type: 'start', position: { x: 360, y: -160 }, data: {} },
    { id: 'menu', type: 'buttons', position: { x: 330, y: -40 }, data: { text: '{greeting} 👋 Soy el asistente de *WhatServices*.\n¿Qué deseas hacer?', buttons: [{ id: 'buscar', label: '🔎 Buscar servicio' }, { id: 'proveedor', label: '🧰 Ser proveedor' }, { id: 'todos', label: '📋 Ver todos' }] } },
    { id: 'msg_register', type: 'message', position: { x: -40, y: 20 }, data: { text: '¡Excelente! 🧰 Únete como profesional y empieza a recibir clientes aquí:\n👉 {webRegister}' } },
    { id: 'msg_allproviders', type: 'message', position: { x: -40, y: 150 }, data: { text: 'Aquí puedes ver a *todos* los profesionales por categoría 👇\n👉 {webProviders}' } },
    { id: 'node_intent', type: 'intent', position: { x: 350, y: 90 }, data: { intents: ['saludo', 'ayuda', 'despedida', 'hablar-humano'] } },
    { id: 'msg_saludo', type: 'message', position: { x: 680, y: 40 }, data: { text: '{greeting}, {firstName}! 😊 Con gusto te ayudo.' } },
    { id: 'msg_ayuda', type: 'message', position: { x: 680, y: 140 }, data: { text: 'Te ayudo a encontrar profesionales cerca de ti. 🛠️' } },
    { id: 'msg_humano', type: 'message', position: { x: 680, y: 240 }, data: { text: '¡Claro! Te paso con un asesor humano. 🙋 En un momento te contactan.' } },
    { id: 'msg_despedida', type: 'message', position: { x: 900, y: 40 }, data: { text: '¡Gracias por usar *WhatServices*! 👋 Escríbeme cuando quieras.' } },
    { id: 'ask_service', type: 'ask', position: { x: 340, y: 220 }, data: { text: '¿Qué servicio necesitas? 🔍\n\nEstas son las categorías disponibles:\n{servicesAvailable}', saveAs: 'serviceText', capture: 'text' } },
    { id: 'act_match', type: 'action', position: { x: 350, y: 330 }, data: { action: 'matchService', params: {} } },
    { id: 'msg_noservice', type: 'message', position: { x: 60, y: 360 }, data: { text: 'No reconocí ese servicio 🤔. Estos son los disponibles:\n\n{servicesAvailable}' } },
    { id: 'ask_mode', type: 'buttons', position: { x: 350, y: 440 }, data: { text: 'Perfecto, *{service}* ✅\n¿Cómo los prefieres?', buttons: [{ id: 'near', label: '📍 Más cercanos' }, { id: 'rated', label: '⭐ Mejor calificados' }] } },
    { id: 'ask_zip', type: 'ask', position: { x: 110, y: 560 }, data: { text: 'Dame tu *código postal* (5 dígitos) para buscar cerca de ti. 📍', saveAs: 'zip', capture: 'zip' } },
    { id: 'act_search_near', type: 'action', position: { x: 120, y: 670 }, data: { action: 'search', params: { mode: 'near' } } },
    { id: 'act_search_rated', type: 'action', position: { x: 540, y: 560 }, data: { action: 'search', params: { mode: 'score' } } },
    { id: 'msg_noresults', type: 'message', position: { x: 760, y: 640 }, data: { text: 'Por ahora no tengo profesionales de *{service}* disponibles 😕.\nPuedes verlos todos aquí: {webProviders}' } },
    { id: 'act_catalog', type: 'action', position: { x: 350, y: 790 }, data: { action: 'sendCatalog', params: {} } },
    { id: 'ask_pick', type: 'ask', position: { x: 350, y: 900 }, data: { text: '', saveAs: 'pick', capture: 'text' } },
    { id: 'node_exit', type: 'intent', position: { x: 350, y: 1010 }, data: { intents: ['despedida'] } },
    { id: 'act_works', type: 'action', position: { x: 350, y: 1120 }, data: { action: 'showWorks', params: {} } },
    { id: 'end', type: 'end', position: { x: 900, y: 240 }, data: {} },
  ],
  edges: [
    { id: 'e1', source: 'start', target: 'menu' },
    { id: 'e2', source: 'menu', target: 'ask_service', sourceHandle: 'btn:buscar', label: 'Buscar' },
    { id: 'e3', source: 'menu', target: 'msg_register', sourceHandle: 'btn:proveedor', label: 'Proveedor' },
    { id: 'e4', source: 'menu', target: 'msg_allproviders', sourceHandle: 'btn:todos', label: 'Ver todos' },
    { id: 'e5', source: 'menu', target: 'node_intent', sourceHandle: 'else', label: 'Otro/texto' },
    { id: 'e6', source: 'msg_register', target: 'end' },
    { id: 'e7', source: 'msg_allproviders', target: 'end' },
    { id: 'e8', source: 'node_intent', target: 'msg_saludo', sourceHandle: 'intent:saludo' },
    { id: 'e9', source: 'node_intent', target: 'msg_ayuda', sourceHandle: 'intent:ayuda' },
    { id: 'e10', source: 'node_intent', target: 'msg_despedida', sourceHandle: 'intent:despedida' },
    { id: 'e11', source: 'node_intent', target: 'msg_humano', sourceHandle: 'intent:hablar-humano' },
    { id: 'e12', source: 'node_intent', target: 'act_match', sourceHandle: 'else', label: 'Servicio' },
    { id: 'e13', source: 'msg_saludo', target: 'ask_service' },
    { id: 'e14', source: 'msg_ayuda', target: 'ask_service' },
    { id: 'e15', source: 'msg_humano', target: 'end' },
    { id: 'e16', source: 'msg_despedida', target: 'end' },
    { id: 'e17', source: 'ask_service', target: 'act_match' },
    { id: 'e18', source: 'act_match', target: 'ask_mode', sourceHandle: 'matched', label: 'Sí reconoció' },
    { id: 'e19', source: 'act_match', target: 'msg_noservice', sourceHandle: 'notMatched', label: 'No reconoció' },
    { id: 'e20', source: 'msg_noservice', target: 'ask_service' },
    { id: 'e21', source: 'ask_mode', target: 'ask_zip', sourceHandle: 'btn:near', label: 'Cercanos' },
    { id: 'e22', source: 'ask_mode', target: 'act_search_rated', sourceHandle: 'btn:rated', label: 'Calificados' },
    { id: 'e23', source: 'ask_mode', target: 'act_search_rated', sourceHandle: 'else' },
    { id: 'e24', source: 'ask_zip', target: 'act_search_near' },
    { id: 'e25', source: 'act_search_near', target: 'act_catalog', sourceHandle: 'found' },
    { id: 'e26', source: 'act_search_near', target: 'msg_noresults', sourceHandle: 'empty' },
    { id: 'e27', source: 'act_search_rated', target: 'act_catalog', sourceHandle: 'found' },
    { id: 'e28', source: 'act_search_rated', target: 'msg_noresults', sourceHandle: 'empty' },
    { id: 'e29', source: 'msg_noresults', target: 'end' },
    { id: 'e30', source: 'act_catalog', target: 'ask_pick', sourceHandle: 'found' },
    { id: 'e31', source: 'act_catalog', target: 'msg_noresults', sourceHandle: 'empty' },
    { id: 'e32', source: 'ask_pick', target: 'node_exit' },
    { id: 'e33', source: 'node_exit', target: 'msg_despedida', sourceHandle: 'intent:despedida', label: 'Salir' },
    { id: 'e34', source: 'node_exit', target: 'act_works', sourceHandle: 'else', label: 'Elegir' },
    { id: 'e35', source: 'act_works', target: 'ask_pick', sourceHandle: 'shown' },
    { id: 'e36', source: 'act_works', target: 'act_catalog', sourceHandle: 'back', label: 'Volver' },
    { id: 'e37', source: 'act_works', target: 'ask_service', sourceHandle: 'menu', label: 'Otra búsqueda' },
  ],
})
...
export const TEMPLATES = [
  ...
  { id: 'buscador', name: 'Buscar proveedores 🔍', icon: '🔍', description: 'PRO con componentes de Meta: menú con botones, modo (cercanos/calificados) con botones, fotos de proveedores y LISTA interactiva para elegir (sin escribir números), ver trabajos con botones. Intenciones robustas y reinicio.', build: buscador, ensureIntents: true },
]
