...
export const FLOW_VARS = [
  ...
  { v: '{webProviders}', d: 'Link a TODOS los profesionales (web)' },
  { v: '{webService}', d: 'Link a profesionales del servicio elegido (web)' },
  { v: '{webRegister}', d: 'Link al formulario para ser proveedor (web)' },
